...
(DuckDuckGo) (langchain-
   ...
   Raw Research Text
          ...
          ▼
┌─────────────────────┐
│   report_builder.py │  ← Parses + formats
└─────────────────────┘
          │
          ▼
...
| Model | `mistral:7b` (or any Ollama model) |
...
├── report_builder.py     # Parses raw output → formatted report
├── requirements.txt      # Python dependencies
├── README.md
└── sample_outputs/
    ├── report_ai_in_education_output1.txt
    └── report_ai_in_education_output2.txt
```
...
| `Ollama (Mistral:7b)` | LLM reasoning | ❌ Local only |
